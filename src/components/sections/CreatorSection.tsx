            ...
            <div className="animate-fade-in" style={{animationDelay: '0.3s'}}>
              <div className="relative bg-gradient-to-br from-card/60 to-card/30 border-2 border-accent/30 rounded-3xl p-8 backdrop-blur-md">
                ...
                <div className="relative max-w-md mx-auto mb-6">
                  <img 
                    src="https://i.postimg.cc/8cdGJ8CM/estudante-prof.webp" 
                    alt="Equipe ENEM IA 360 - Especialistas em Educação" 
                    className="w-full h-auto rounded-2xl shadow-lg"
                  />
                </div>
                
                <div className="text-center">
                  <h3 className="text-2xl font-bold text-foreground mb-2">Equipe ENEM IA 360</h3>
