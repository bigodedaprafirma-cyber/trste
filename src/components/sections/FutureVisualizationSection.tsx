        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-16">
            <div className="relative max-w-2xl mx-auto">
              <img 
                src="https://i.postimg.cc/507vhGJ3/COMEMORANDIO-compressed.webp" 
                alt="Estudantes comemorando aprovação no ENEM" 
                className="w-full h-auto rounded-2xl shadow-[0_0_40px_hsl(var(--accent)/0.2)]"
              />
            </div>
          </div>
