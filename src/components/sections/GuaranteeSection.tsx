  ...
  const guaranteeFeatures = [
    {
      ...
      description: "Use todo o material por uma semana completa sem compromisso. Explore cada recurso e veja a transformação."
    },
    {
      icon: <RefreshCw className="w-6 h-6" />,
      title: "Reembolso Total",
      description: "Se por qualquer motivo você não ficar satisfeito, nós devolvemos 100% do seu dinheiro na hora."
    },
    {
      icon: <CheckCircle className="w-6 h-6" />,
      title: "Sem Burocracias",
      description: "Processo simples e rápido, sem perguntas complicadas. Sua tranquilidade é nossa prioridade."
    }
  ];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
              Sua Satisfação é
              <br />
              <span className="text-green-400">100% Garantida ou Seu Dinheiro de Volta!</span>
            </h2>
