...
const ObjectionBreakSection = () => {
  const objections = [
    ...
    },
    {
      ...
      answer: "Pense assim: R$ 24,90 dividido em 12x dá menos de R$ 2,50 por mês - menos que um café! É um investimento único que pode mudar completamente seu futuro. Quanto vale para você conquistar a vaga dos seus sonhos? Além disso, com nossa garantia de 7 dias, você pode testar sem riscos."
    },
    {
