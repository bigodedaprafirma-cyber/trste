  ...
  const problems = [
    {
      ...
      description: "Com tantos conteúdos e uma rotina apertada, organizar os estudos de forma eficiente parece uma missão impossível, deixando você com a sensação de que nunca vai dar conta."
    },
    {
      icon: <Brain className="w-8 h-8 text-red-400" />,
      question: "Sente que está estudando, mas não está aprendendo?",
      description: "Passar horas a fio nos livros sem um método claro ou feedback pode ser frustrante, gerando dúvidas sobre a real absorção do conteúdo."
    },
    {
      icon: <PenTool className="w-8 h-8 text-red-400" />,
      question: "Redação continua sendo seu maior pesadelo?",
      description: "Sem feedback personalizado e imediato, é quase impossível identificar e corrigir os erros que impedem sua nota máxima, transformando a redação em uma fonte constante de ansiedade."
    },
    {
      icon: <AlertTriangle className="w-8 h-8 text-red-400" />,
      question: "Não sabe por onde começar ou o que priorizar?",
      description: "A falta de um plano de estudos personalizado e adaptado às suas lacunas gera ansiedade, desperdício de tempo e a sensação de estar sempre correndo atrás."
    }
  ];
          ...
          <div className="text-center mb-16">
            ...
            <div className="relative max-w-2xl mx-auto mb-12">
              <div className="relative rounded-2xl overflow-hidden shadow-[0_0_40px_hsl(var(--accent)/0.2)]">
                <img 
                  src="https://i.postimg.cc/x1Gvcw6m/ESTUDO-comprimido.webp" 
            ...
            <div className="inline-flex items-center gap-3 px-6 py-3 bg-accent/10 border border-accent/20 rounded-full">
              <span className="text-accent text-2xl">💡</span>
               <span className="text-foreground font-semibold">
                 E se existisse uma solução inteligente, personalizada e sempre disponível para todos esses problemas?
               </span>
            </div>
          </div>
        </div>
